...
-- AddForeignKey
ALTER TABLE "service_records" ADD CONSTRAINT "service_records_serviceId_fkey" FOREIGN KEY ("serviceId") REFERENCES "bikes"("bikeId") ON DELETE RESTRICT ON UPDATE CASCADE;
